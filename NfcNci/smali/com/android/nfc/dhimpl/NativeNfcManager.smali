...
.field private final mT4tNfceeMgr:Lcom/android/nfc/dhimpl/NativeT4tNfceeManager;
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/nfc/DeviceHost$DeviceHostListener;)V
    ...
    .line 86
    new-instance v0, Lcom/android/nfc/dhimpl/NativeT4tNfceeManager;

    invoke-direct {v0}, Lcom/android/nfc/dhimpl/NativeT4tNfceeManager;-><init>()V

    iput-object v0, p0, Lcom/android/nfc/dhimpl/NativeNfcManager;->mT4tNfceeMgr:Lcom/android/nfc/dhimpl/NativeT4tNfceeManager;
...
.method private notifyonReaderRemoveCard()V
    .locals 1

    .line 580
    iget-object v0, p0, Lcom/android/nfc/dhimpl/NativeNfcManager;->mListener:Lcom/android/nfc/DeviceHost$DeviceHostListener;

    invoke-interface {v0}, Lcom/android/nfc/DeviceHost$DeviceHostListener;->onReaderRemoveCard()V

    .line 581
    return-void
.end method

.method private notifyonReaderRequestedFail()V
    .locals 1

    .line 560
    iget-object v0, p0, Lcom/android/nfc/dhimpl/NativeNfcManager;->mListener:Lcom/android/nfc/DeviceHost$DeviceHostListener;

    invoke-interface {v0}, Lcom/android/nfc/DeviceHost$DeviceHostListener;->onReaderRequestedFail()V

    .line 561
    return-void
.end method

.method private notifyonReaderRestart()V
    .locals 1

    .line 576
    iget-object v0, p0, Lcom/android/nfc/dhimpl/NativeNfcManager;->mListener:Lcom/android/nfc/DeviceHost$DeviceHostListener;

    invoke-interface {v0}, Lcom/android/nfc/DeviceHost$DeviceHostListener;->onReaderRestart()V

    .line 577
    return-void
.end method

.method private notifyonReaderStartFail()V
    .locals 1

    .line 584
    iget-object v0, p0, Lcom/android/nfc/dhimpl/NativeNfcManager;->mListener:Lcom/android/nfc/DeviceHost$DeviceHostListener;

    invoke-interface {v0}, Lcom/android/nfc/DeviceHost$DeviceHostListener;->onReaderStartFail()V

    .line 585
    return-void
.end method

.method private notifyonReaderStartSuccess()V
    .locals 1

    .line 568
    iget-object v0, p0, Lcom/android/nfc/dhimpl/NativeNfcManager;->mListener:Lcom/android/nfc/DeviceHost$DeviceHostListener;

    invoke-interface {v0}, Lcom/android/nfc/DeviceHost$DeviceHostListener;->onReaderStartSuccess()V

    .line 569
    return-void
.end method

.method private notifyonReaderStopSuccess()V
    .locals 1

    .line 572
    iget-object v0, p0, Lcom/android/nfc/dhimpl/NativeNfcManager;->mListener:Lcom/android/nfc/DeviceHost$DeviceHostListener;

    invoke-interface {v0}, Lcom/android/nfc/DeviceHost$DeviceHostListener;->onReaderStopSuccess()V

    .line 573
    return-void
.end method

.method private notifyonReaderTimeout()V
    .locals 1

    .line 589
    iget-object v0, p0, Lcom/android/nfc/dhimpl/NativeNfcManager;->mListener:Lcom/android/nfc/DeviceHost$DeviceHostListener;

    invoke-interface {v0}, Lcom/android/nfc/DeviceHost$DeviceHostListener;->onReaderTimeout()V
...
.method public doReadT4tData([B)[B
    ...
    .line 330
    iget-object v0, p0, Lcom/android/nfc/dhimpl/NativeNfcManager;->mT4tNfceeMgr:Lcom/android/nfc/dhimpl/NativeT4tNfceeManager;

    invoke-virtual {v0, p1}, Lcom/android/nfc/dhimpl/NativeT4tNfceeManager;->doReadT4tData([B)[B
...
.method public native doResonantFrequency(Z)V
.end method

.method public native doSetFieldDetectMode(Z)I
.end method
...
.method public doWriteT4tData([B[BI)I
    ...
    invoke-virtual {v0, p1, p2, p3}, Lcom/android/nfc/dhimpl/NativeT4tNfceeManager;->doWriteT4tData([B[BI)I
...
.method public native isFieldDetectEnabled()Z
.end method
