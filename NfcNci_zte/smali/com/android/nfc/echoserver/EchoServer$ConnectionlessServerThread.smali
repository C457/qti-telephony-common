...
.method public run()V
    ...
    const-string v2, "about create LLCP connectionless socket"
    ...
    const-string v3, "urn:nfc:sn:cl-echo"

    invoke-virtual {v1, v2, v3}, Lcom/android/nfc/NfcService;->createLlcpConnectionLessSocket(ILjava/lang/String;)Lcom/android/nfc/DeviceHost$LlcpConnectionlessSocket;
    ...
    const-string v2, "failed to create LLCP connectionless socket"
    ...
    iput v4, p0, Lcom/android/nfc/echoserver/EchoServer$ConnectionlessServerThread;->mRemoteSap:I

    .line 316
    iget-object v4, p0, Lcom/android/nfc/echoserver/EchoServer$ConnectionlessServerThread;->echoMachine:Lcom/android/nfc/echoserver/EchoServer$EchoMachine;
