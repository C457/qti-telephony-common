...
.method static handleRequest(Lcom/android/nfc/snep/SnepMessenger;Lcom/android/nfc/sneptest/ExtDtaSnepServer$Callback;)Z
    ...
    const-string v4, "getting message "
    ...
    invoke-interface {p1, v0, v2}, Lcom/android/nfc/sneptest/ExtDtaSnepServer$Callback;->doGet(ILandroid/nfc/NdefMessage;)Lcom/android/nfc/snep/SnepMessage;
    ...
    invoke-virtual {v2}, Landroid/nfc/NdefMessage;->toString()Ljava/lang/String;

    move-result-object v2

    invoke-virtual {v0, v2}, Lcom/android/nfc/DtaServiceConnector;->sendMessage(Ljava/lang/String;)V
    ...
    const-string v4, "putting message "
    ...
    const-string v2, "Bad requested length"
