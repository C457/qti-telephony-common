...
.method public run()V
    ...
    .line 217
    .local v0, "communicationSocket":Lcom/android/nfc/DeviceHost$LlcpSocket;
    if-eqz v0, :cond_5
    ...
    invoke-direct {v5, v6, v0, v4}, Lcom/android/nfc/snep/SnepServer$ConnectionThread;-><init>(Lcom/android/nfc/snep/SnepServer;Lcom/android/nfc/DeviceHost$LlcpSocket;I)V
    ...
    .line 226
    .end local v0    # "communicationSocket":Lcom/android/nfc/DeviceHost$LlcpSocket;
    .end local v2    # "serverSocket":Lcom/android/nfc/DeviceHost$LlcpServerSocket;
    goto :goto_2

    .line 225
    .restart local v0    # "communicationSocket":Lcom/android/nfc/DeviceHost$LlcpSocket;
    ...
    .line 228
    .end local v3    # "threadRunning":Z
    .restart local v0    # "threadRunning":Z
    :catch_7
    move-exception v2
    ...
    .line 247
    :try_start_21
    iget-boolean v0, p0, Lcom/android/nfc/snep/SnepServer$ServerThread;->mThreadRunning:Z
    :try_end_21
