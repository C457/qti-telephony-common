...
.method initGL()Z
    ...
    invoke-interface {v1, v3, v4, v5, v6}, Ljavax/microedition/khronos/egl/EGL10;->eglCreateContext(Ljavax/microedition/khronos/egl/EGLDisplay;Ljavax/microedition/khronos/egl/EGLConfig;Ljavax/microedition/khronos/egl/EGLContext;[I)Ljavax/microedition/khronos/egl/EGLContext;
...
.method public run()V
    ...
    .line 173
    invoke-virtual {p0}, Lcom/android/nfc/beam/FireflyRenderer$FireflyRenderThread;->initGL()Z
    ...
    const-string v1, "Failed to initialize OpenGL."
    ...
    .line 177
    :cond_0
    invoke-virtual {p0}, Lcom/android/nfc/beam/FireflyRenderer$FireflyRenderThread;->loadStarTexture()V

    .line 179
    iget-object v0, p0, Lcom/android/nfc/beam/FireflyRenderer$FireflyRenderThread;->mGL:Ljavax/microedition/khronos/opengles/GL10;
    ...
    iget-object v1, p0, Lcom/android/nfc/beam/FireflyRenderer$FireflyRenderThread;->this$0:Lcom/android/nfc/beam/FireflyRenderer;
    ...
    iget-object v0, p0, Lcom/android/nfc/beam/FireflyRenderer$FireflyRenderThread;->this$0:Lcom/android/nfc/beam/FireflyRenderer;
    ...
    .line 197
    .local v5, "firefly":Lcom/android/nfc/beam/FireflyRenderer$Firefly;
    invoke-virtual {v5}, Lcom/android/nfc/beam/FireflyRenderer$Firefly;->reset()V

    .line 196
    .end local v5    # "firefly":Lcom/android/nfc/beam/FireflyRenderer$Firefly;
    ...
    invoke-interface {v2, v4}, Ljavax/microedition/khronos/opengles/GL10;->glClear(I)V
    ...
    const-string v4, "Could not swap buffers"

    invoke-static {v2, v4}, Landroid/util/Log;->e(Ljava/lang/String;Ljava/lang/String;)I

    .line 206
    iput-boolean v1, p0, Lcom/android/nfc/beam/FireflyRenderer$FireflyRenderThread;->mFinished:Z
    ...
    :goto_2
    iget-boolean v0, p0, Lcom/android/nfc/beam/FireflyRenderer$FireflyRenderThread;->mFinished:Z
    ...
    .line 214
    .local v7, "timeElapsedMs":J
    invoke-static {}, Ljava/lang/System;->currentTimeMillis()J

    move-result-wide v5

    .line 216
    invoke-direct {p0}, Lcom/android/nfc/beam/FireflyRenderer$FireflyRenderThread;->checkCurrent()V

    .line 218
    iget-object v0, p0, Lcom/android/nfc/beam/FireflyRenderer$FireflyRenderThread;->mGL:Ljavax/microedition/khronos/opengles/GL10;

    invoke-interface {v0, v4}, Ljavax/microedition/khronos/opengles/GL10;->glClear(I)V
    ...
    .line 226
    .local v10, "firefly":Lcom/android/nfc/beam/FireflyRenderer$Firefly;
    invoke-virtual {v10, v7, v8}, Lcom/android/nfc/beam/FireflyRenderer$Firefly;->updatePositionAndScale(J)V

    .line 227
    iget-object v11, p0, Lcom/android/nfc/beam/FireflyRenderer$FireflyRenderThread;->mGL:Ljavax/microedition/khronos/opengles/GL10;

    invoke-virtual {v10, v11}, Lcom/android/nfc/beam/FireflyRenderer$Firefly;->draw(Ljavax/microedition/khronos/opengles/GL10;)V

    .line 225
    .end local v10    # "firefly":Lcom/android/nfc/beam/FireflyRenderer$Firefly;
    ...
    iget-object v9, p0, Lcom/android/nfc/beam/FireflyRenderer$FireflyRenderThread;->mEglSurface:Ljavax/microedition/khronos/egl/EGLSurface;
    ...
    const-string v2, "Could not swap buffers"
    ...
    .line 242
    :cond_6
    invoke-direct {p0}, Lcom/android/nfc/beam/FireflyRenderer$FireflyRenderThread;->finishGL()V
