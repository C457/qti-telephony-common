...
.method private handleTransferEvent(Landroid/content/Intent;I)V
    ...
    .line 113
    .local v1, "id":I
    const-string v3, "android.nfc.handover.intent.extra.ADDRESS"
    ...
    .line 117
    :cond_0
    iget-object v4, p0, Lcom/android/nfc/beam/BeamStatusReceiver;->mTransferManager:Lcom/android/nfc/beam/BeamTransferManager;
    ...
    .line 122
    const-string v2, "BeamStatusReceiver"

    const-string v4, "Didn\'t find transfer, stopping"
    ...
    .line 125
    iget-object v4, p0, Lcom/android/nfc/beam/BeamStatusReceiver;->mContext:Landroid/content/Context;
    ...
    invoke-virtual {v2, v1}, Lcom/android/nfc/beam/BeamTransferManager;->setBluetoothTransferId(I)V
    ...
    const-string v6, "android.nfc.handover.intent.extra.TRANSFER_MIME_TYPE"
    ...
    invoke-virtual {v8, v5, v7, v6}, Lcom/android/nfc/beam/BeamTransferManager;->finishTransfer(ZLandroid/net/Uri;Ljava/lang/String;)V
    ...
    invoke-virtual {v5, v4, v6, v6}, Lcom/android/nfc/beam/BeamTransferManager;->finishTransfer(ZLandroid/net/Uri;Ljava/lang/String;)V
    ...
    invoke-virtual {v4, v2}, Lcom/android/nfc/beam/BeamTransferManager;->updateFileProgress(F)V
    ...
    .line 152
    const-string v2, "android.nfc.handover.intent.extra.OBJECT_COUNT"
    ...
    invoke-virtual {v4, v2}, Lcom/android/nfc/beam/BeamTransferManager;->setObjectCount(I)V
