...
.method sendIntent()V
    ...
    const-string v6, "sendIntent  mimeType :"
    ...
    iget-object v5, p0, Lcom/android/nfc/beam/BluetoothOppHandover;->mDevice:Landroid/bluetooth/BluetoothDevice;
    ...
    :try_start_0
    iget-object v7, p0, Lcom/android/nfc/beam/BluetoothOppHandover;->mContext:Landroid/content/Context;
    ...
    invoke-virtual {v7, v8, v5, v6}, Landroid/content/Context;->grantUriPermission(Ljava/lang/String;Landroid/net/Uri;I)V
    :try_end_0
    ...
    const-string v7, "BluetoothOppHandover"
    ...
    .line 127
    :goto_2
    const-string v2, "BluetoothOppHandover"

    const-string v3, "Handing off outging transfer to BT"
