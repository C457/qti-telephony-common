.class public Lcom/dts/dtsxultra/util/UsbConnectionNotificationManager;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/dts/dtsxultra/util/UsbConnectionNotificationManager$NotificationReceiver;
    }
.end annotation
...
.field private static b:Lcom/dts/dtsxultra/util/UsbConnectionNotificationManager;
...
.method static constructor <clinit>()V
    ...
    const-class v0, Lcom/dts/dtsxultra/util/UsbConnectionNotificationManager;

    invoke-virtual {v0}, Ljava/lang/Class;->getSimpleName()Ljava/lang/String;

    move-result-object v0

    sput-object v0, Lcom/dts/dtsxultra/util/UsbConnectionNotificationManager;->a:Ljava/lang/String;
...
.method private constructor <init>(Ljava/lang/String;Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/dts/dtsxultra/util/UsbConnectionNotificationManager;->d:Landroid/app/Notification$Builder;

    iget-object v0, p0, Lcom/dts/dtsxultra/util/UsbConnectionNotificationManager;->d:Landroid/app/Notification$Builder;
    ...
    const-string v2, "dts.dtsxultra.intent.action.USB_DISMISS"

    invoke-static {v1, v2}, Lcom/dts/dtsxultra/util/UsbConnectionNotificationManager;->a(Landroid/content/Context;Ljava/lang/String;)Landroid/content/Intent;

    move-result-object v1

    iget-object v2, p0, Lcom/dts/dtsxultra/util/UsbConnectionNotificationManager;->c:Landroid/content/Context;
    ...
    invoke-static {p2, v1}, Lcom/dts/dtsxultra/util/UsbConnectionNotificationManager;->a(Landroid/content/Context;Ljava/lang/String;)Landroid/content/Intent;
...
.method static synthetic a(Lcom/dts/dtsxultra/util/UsbConnectionNotificationManager;Landroid/app/Notification;)Landroid/app/Notification;
    .locals 0

    iput-object p1, p0, Lcom/dts/dtsxultra/util/UsbConnectionNotificationManager;->e:Landroid/app/Notification;

    return-object p1
.end method

.method static synthetic a(Lcom/dts/dtsxultra/util/UsbConnectionNotificationManager;)Landroid/content/Context;
    .locals 1

    iget-object v0, p0, Lcom/dts/dtsxultra/util/UsbConnectionNotificationManager;->c:Landroid/content/Context;
...
.method private static a(Landroid/content/Context;Ljava/lang/String;)Landroid/content/Intent;
    ...
    const-class v2, Lcom/dts/dtsxultra/util/UsbConnectionNotificationManager$NotificationReceiver;
...
.method static synthetic a()Ljava/lang/String;
    ...
    sget-object v0, Lcom/dts/dtsxultra/util/UsbConnectionNotificationManager;->a:Ljava/lang/String;
...
.method private a(Landroid/content/Context;Lcom/dts/dtssdk/a/a;Ljava/lang/String;)V
    ...
    iget-object v1, p0, Lcom/dts/dtsxultra/util/UsbConnectionNotificationManager;->d:Landroid/app/Notification$Builder;
    ...
    :cond_0
    iput-object p2, p0, Lcom/dts/dtsxultra/util/UsbConnectionNotificationManager;->f:Lcom/dts/dtssdk/a/a;

    iput-object p3, p0, Lcom/dts/dtsxultra/util/UsbConnectionNotificationManager;->g:Ljava/lang/String;

    iget-object v0, p0, Lcom/dts/dtsxultra/util/UsbConnectionNotificationManager;->c:Landroid/content/Context;

    const/4 v1, 0x1

    new-instance v2, Lcom/dts/dtsxultra/util/UsbConnectionNotificationManager$2;

    invoke-direct {v2, p0, p2, p1}, Lcom/dts/dtsxultra/util/UsbConnectionNotificationManager$2;-><init>(Lcom/dts/dtsxultra/util/UsbConnectionNotificationManager;Lcom/dts/dtssdk/a/a;Landroid/content/Context;)V
...
.method public static a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V
    ...
    new-instance v1, Lcom/dts/dtsxultra/util/UsbConnectionNotificationManager$1;

    invoke-direct {v1, p1, p0, p2}, Lcom/dts/dtsxultra/util/UsbConnectionNotificationManager$1;-><init>(Ljava/lang/String;Landroid/content/Context;Ljava/lang/String;)V
...
.method static synthetic a(Lcom/dts/dtsxultra/util/UsbConnectionNotificationManager;Landroid/content/Context;Lcom/dts/dtssdk/a/a;Ljava/lang/String;)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lcom/dts/dtsxultra/util/UsbConnectionNotificationManager;->a(Landroid/content/Context;Lcom/dts/dtssdk/a/a;Ljava/lang/String;)V

    return-void
.end method

.method static synthetic a(Lcom/dts/dtsxultra/util/UsbConnectionNotificationManager;Lcom/dts/dtssdk/a/j;)V
    .locals 4
    ...
    iget-object v0, p0, Lcom/dts/dtsxultra/util/UsbConnectionNotificationManager;->f:Lcom/dts/dtssdk/a/a;

    iget-object v1, p0, Lcom/dts/dtsxultra/util/UsbConnectionNotificationManager;->g:Ljava/lang/String;
    ...
    new-instance v3, Lcom/dts/dtsxultra/util/UsbConnectionNotificationManager$3;

    invoke-direct {v3, p0, v0}, Lcom/dts/dtsxultra/util/UsbConnectionNotificationManager$3;-><init>(Lcom/dts/dtsxultra/util/UsbConnectionNotificationManager;Lcom/dts/dtssdk/a/a;)V
...
.method static synthetic b(Lcom/dts/dtsxultra/util/UsbConnectionNotificationManager;)Landroid/app/Notification$Builder;
    .locals 1
...
.method static synthetic c(Lcom/dts/dtsxultra/util/UsbConnectionNotificationManager;)V
    ...
    invoke-static {v0}, Lcom/dts/dtsxultra/util/UsbConnectionNotificationManager;->a(Landroid/content/Context;)V
