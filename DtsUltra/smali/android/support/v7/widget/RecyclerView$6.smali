...
.method public final a(I)Landroid/support/v7/widget/RecyclerView$w;
    ...
    iget-object v0, v4, Landroid/support/v7/widget/RecyclerView;->g:Landroid/support/v7/widget/ai;
    ...
    invoke-virtual {v0, v3}, Landroid/support/v7/widget/ai;->c(I)Landroid/view/View;
    ...
    iget v6, v0, Landroid/support/v7/widget/RecyclerView$w;->c:I

    if-ne v6, p1, :cond_4

    iget-object v1, v4, Landroid/support/v7/widget/RecyclerView;->g:Landroid/support/v7/widget/ai;

    iget-object v6, v0, Landroid/support/v7/widget/RecyclerView$w;->a:Landroid/view/View;

    invoke-virtual {v1, v6}, Landroid/support/v7/widget/ai;->d(Landroid/view/View;)Z
    ...
    invoke-virtual {v1, v3}, Landroid/support/v7/widget/ai;->d(Landroid/view/View;)Z
...
.method public final a(IILjava/lang/Object;)V
    ...
    iget-object v0, v2, Landroid/support/v7/widget/RecyclerView;->g:Landroid/support/v7/widget/ai;
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/ai;->c(I)Landroid/view/View;
    ...
    invoke-virtual {v5, v8}, Landroid/support/v7/widget/RecyclerView$w;->b(I)V

    invoke-virtual {v5, p3}, Landroid/support/v7/widget/RecyclerView$w;->a(Ljava/lang/Object;)V
    ...
    iput-boolean v7, v0, Landroid/support/v7/widget/RecyclerView$j;->e:Z
    ...
    invoke-virtual {v0, v8}, Landroid/support/v7/widget/RecyclerView$w;->b(I)V
...
.method public final c(II)V
    ...
    iget-object v1, v2, Landroid/support/v7/widget/RecyclerView;->g:Landroid/support/v7/widget/ai;
    ...
    invoke-virtual {v4, v1}, Landroid/support/v7/widget/ai;->c(I)Landroid/view/View;
    ...
    invoke-virtual {v4, p2, v0}, Landroid/support/v7/widget/RecyclerView$w;->a(IZ)V

    iget-object v4, v2, Landroid/support/v7/widget/RecyclerView;->G:Landroid/support/v7/widget/RecyclerView$t;

    iput-boolean v6, v4, Landroid/support/v7/widget/RecyclerView$t;->f:Z
    ...
    :cond_1
    iget-object v3, v2, Landroid/support/v7/widget/RecyclerView;->e:Landroid/support/v7/widget/RecyclerView$o;
    ...
    invoke-virtual {v0, p2, v6}, Landroid/support/v7/widget/RecyclerView$w;->a(IZ)V
...
.method public final d(II)V
    ...
    iget-object v0, v7, Landroid/support/v7/widget/RecyclerView;->g:Landroid/support/v7/widget/ai;
    ...
    iget-object v9, v7, Landroid/support/v7/widget/RecyclerView;->g:Landroid/support/v7/widget/ai;

    invoke-virtual {v9, v5}, Landroid/support/v7/widget/ai;->c(I)Landroid/view/View;
    ...
    invoke-virtual {v9, v10, v6}, Landroid/support/v7/widget/RecyclerView$w;->a(IZ)V

    :goto_2
    iget-object v9, v7, Landroid/support/v7/widget/RecyclerView;->G:Landroid/support/v7/widget/RecyclerView$t;

    iput-boolean v2, v9, Landroid/support/v7/widget/RecyclerView$t;->f:Z
    ...
    :cond_2
    invoke-virtual {v9, v0, v6}, Landroid/support/v7/widget/RecyclerView$w;->a(IZ)V

    goto :goto_2

    :cond_3
    iget-object v8, v7, Landroid/support/v7/widget/RecyclerView;->e:Landroid/support/v7/widget/RecyclerView$o;
    ...
    iget v10, v0, Landroid/support/v7/widget/RecyclerView$w;->c:I
    ...
    invoke-virtual {v0, v10, v6}, Landroid/support/v7/widget/RecyclerView$w;->a(IZ)V
    ...
    :cond_6
    invoke-virtual {v0, v1, v6}, Landroid/support/v7/widget/RecyclerView$w;->a(IZ)V
