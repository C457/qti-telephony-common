...
.method constructor <init>(Landroid/support/v7/widget/ai$b;)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ai;->b:Landroid/support/v7/widget/ai$a;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Landroid/support/v7/widget/ai;->c:Ljava/util/List;
...
.method final a(I)I
    ...
    invoke-virtual {v3, v0}, Landroid/support/v7/widget/ai$a;->e(I)I
...
.method final a(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;Z)V
    ...
    invoke-virtual {v1, v0, p4}, Landroid/support/v7/widget/ai$a;->a(IZ)V
    ...
    invoke-interface {v1, p1, v0, p3}, Landroid/support/v7/widget/ai$b;->a(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;)V

    return-void

    :cond_1
    invoke-virtual {p0, p2}, Landroid/support/v7/widget/ai;->a(I)I
...
.method final a(Landroid/view/View;IZ)V
    ...
    invoke-virtual {v1, v0, p3}, Landroid/support/v7/widget/ai$a;->a(IZ)V
    ...
    invoke-interface {v1, p1, v0}, Landroid/support/v7/widget/ai$b;->a(Landroid/view/View;I)V
...
.method final b(I)Landroid/view/View;
    ...
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/ai;->a(I)I

    move-result v0

    iget-object v1, p0, Landroid/support/v7/widget/ai;->a:Landroid/support/v7/widget/ai$b;

    invoke-interface {v1, v0}, Landroid/support/v7/widget/ai$b;->b(I)Landroid/view/View;
...
.method final c(Landroid/view/View;)I
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/ai$a;->e(I)I
...
.method final d(I)V
    ...
    invoke-interface {v1, v0}, Landroid/support/v7/widget/ai$b;->c(I)V
