...
.method public a(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;IIII)Z
    ...
    invoke-virtual {p0, v0}, Landroid/support/design/widget/f;->a(Ljava/util/List;)Landroid/view/View;

    move-result-object v2

    if-eqz v2, :cond_4

    invoke-static {v2}, Landroid/support/v4/h/r;->r(Landroid/view/View;)Z
    ...
    invoke-static {p2}, Landroid/support/v4/h/r;->s(Landroid/view/View;)V
    ...
    invoke-virtual {p0, v2}, Landroid/support/design/widget/f;->b(Landroid/view/View;)I
...
.method protected final b(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;I)V
    ...
    iget-object v3, p0, Landroid/support/design/widget/f;->a:Landroid/graphics/Rect;
    ...
    invoke-virtual {v1}, Landroid/support/v4/h/z;->c()I
    ...
    :cond_0
    iget-object v4, p0, Landroid/support/design/widget/f;->b:Landroid/graphics/Rect;
    ...
    invoke-virtual {p0, v6}, Landroid/support/design/widget/f;->c(Landroid/view/View;)I
...
.method final c(Landroid/view/View;)I
    ...
    iget v1, p0, Landroid/support/design/widget/f;->d:I
    ...
    iget v2, p0, Landroid/support/design/widget/f;->d:I
