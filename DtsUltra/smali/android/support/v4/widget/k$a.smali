...
.method constructor <init>(Landroid/view/ActionMode$Callback;Landroid/widget/TextView;)V
    ...
    iput-boolean v0, p0, Landroid/support/v4/widget/k$a;->f:Z
...
.method public final onActionItemClicked(Landroid/view/ActionMode;Landroid/view/MenuItem;)Z
    ...
    iget-object v0, p0, Landroid/support/v4/widget/k$a;->a:Landroid/view/ActionMode$Callback;
...
.method public final onPrepareActionMode(Landroid/view/ActionMode;Landroid/view/Menu;)Z
    ...
    iget-boolean v0, p0, Landroid/support/v4/widget/k$a;->f:Z

    if-nez v0, :cond_0

    iput-boolean v2, p0, Landroid/support/v4/widget/k$a;->f:Z
    ...
    iput-object v0, p0, Landroid/support/v4/widget/k$a;->c:Ljava/lang/Class;

    iget-object v0, p0, Landroid/support/v4/widget/k$a;->c:Ljava/lang/Class;
    ...
    iput-object v0, p0, Landroid/support/v4/widget/k$a;->d:Ljava/lang/reflect/Method;

    const/4 v0, 0x1

    iput-boolean v0, p0, Landroid/support/v4/widget/k$a;->e:Z
    :try_end_0
    ...
    :goto_0
    :try_start_1
    iget-boolean v0, p0, Landroid/support/v4/widget/k$a;->e:Z
    ...
    iget-object v0, p0, Landroid/support/v4/widget/k$a;->d:Ljava/lang/reflect/Method;
    ...
    :goto_3
    iput-object v9, p0, Landroid/support/v4/widget/k$a;->c:Ljava/lang/Class;

    iput-object v9, p0, Landroid/support/v4/widget/k$a;->d:Ljava/lang/reflect/Method;
    ...
    invoke-static {}, Landroid/support/v4/widget/k$a;->a()Landroid/content/Intent;
    ...
    iget-object v1, p0, Landroid/support/v4/widget/k$a;->b:Landroid/widget/TextView;
