...
.method private a(Landroid/support/v4/app/e;Ljava/lang/String;I)V
    ...
    iget-object v2, p1, Landroid/support/v4/app/e;->A:Ljava/lang/String;
    ...
    :cond_2
    iput-object p2, p1, Landroid/support/v4/app/e;->A:Ljava/lang/String;
    ...
    iget v2, p1, Landroid/support/v4/app/e;->y:I
    ...
    invoke-direct {v0, p3, p1}, Landroid/support/v4/app/b$a;-><init>(ILandroid/support/v4/app/e;)V
...
# virtual methods
.method final a(Ljava/util/ArrayList;Landroid/support/v4/app/e;)Landroid/support/v4/app/e;
    .locals 10
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public final a()Landroid/support/v4/app/o;
    ...
    iput-boolean v0, p0, Landroid/support/v4/app/b;->i:Z

    const/4 v0, 0x0

    iput-object v0, p0, Landroid/support/v4/app/b;->k:Ljava/lang/String;

    return-object p0
.end method

.method public final a(Landroid/support/v4/app/e;)Landroid/support/v4/app/o;
    .locals 2
    ...
    invoke-direct {p0, p1, v0, v1}, Landroid/support/v4/app/b;->a(Landroid/support/v4/app/e;Ljava/lang/String;I)V

    return-object p0
.end method

.method public final a(Landroid/support/v4/app/e;Ljava/lang/String;)Landroid/support/v4/app/o;
    .locals 1

    const/4 v0, 0x1

    invoke-direct {p0, p1, p2, v0}, Landroid/support/v4/app/b;->a(Landroid/support/v4/app/e;Ljava/lang/String;I)V
...
.method final a(Z)V
    ...
    invoke-static {v3}, Landroid/support/v4/app/k;->b(I)I
    ...
    invoke-virtual {v2, v3}, Landroid/support/v4/app/e;->b(I)V

    iget-object v3, p0, Landroid/support/v4/app/b;->a:Landroid/support/v4/app/k;

    invoke-virtual {v3, v2}, Landroid/support/v4/app/k;->c(Landroid/support/v4/app/e;)V
    ...
    invoke-virtual {v0, v2}, Landroid/support/v4/app/k;->a(Landroid/support/v4/app/e;)V
    ...
    invoke-static {v2}, Landroid/support/v4/app/k;->e(Landroid/support/v4/app/e;)V
    ...
    invoke-static {v2}, Landroid/support/v4/app/k;->d(Landroid/support/v4/app/e;)V
    ...
    invoke-virtual {v3, v2}, Landroid/support/v4/app/k;->g(Landroid/support/v4/app/e;)V
    ...
    invoke-virtual {v3, v2}, Landroid/support/v4/app/k;->f(Landroid/support/v4/app/e;)V
    ...
    invoke-virtual {v3, v4}, Landroid/support/v4/app/k;->h(Landroid/support/v4/app/e;)V
...
.method final b(Ljava/util/ArrayList;Landroid/support/v4/app/e;)Landroid/support/v4/app/e;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public final b(Landroid/support/v4/app/e;)Landroid/support/v4/app/o;
    .locals 2
...
.method public final c(Landroid/support/v4/app/e;)Landroid/support/v4/app/o;
    .locals 2
...
.method final e()V
    ...
    invoke-virtual {v4, v5}, Landroid/support/v4/app/e;->b(I)V
    ...
    invoke-virtual {v0, v4}, Landroid/support/v4/app/k;->a(Landroid/support/v4/app/e;)V
    ...
    invoke-virtual {v5, v4}, Landroid/support/v4/app/k;->c(Landroid/support/v4/app/e;)V
    ...
    invoke-static {v4}, Landroid/support/v4/app/k;->d(Landroid/support/v4/app/e;)V
    ...
    invoke-static {v4}, Landroid/support/v4/app/k;->e(Landroid/support/v4/app/e;)V
    ...
    invoke-virtual {v5, v4}, Landroid/support/v4/app/k;->f(Landroid/support/v4/app/e;)V
    ...
    invoke-virtual {v5, v4}, Landroid/support/v4/app/k;->g(Landroid/support/v4/app/e;)V
    ...
    invoke-virtual {v5, v6}, Landroid/support/v4/app/k;->h(Landroid/support/v4/app/e;)V
