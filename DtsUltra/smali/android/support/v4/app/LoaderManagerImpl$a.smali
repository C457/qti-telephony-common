...
.field final g:Landroid/support/v4/a/b;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field h:Landroid/support/v4/app/LoaderManagerImpl$b;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field private i:Landroid/arch/lifecycle/e;

.field private j:Landroid/support/v4/a/b;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Landroid/support/v4/a/b",
            "<TD;>;"
...
.method protected final a()V
    ...
    :cond_0
    iget-object v0, p0, Landroid/support/v4/app/LoaderManagerImpl$a;->g:Landroid/support/v4/a/b;

    const/4 v1, 0x1

    iput-boolean v1, v0, Landroid/support/v4/a/b;->c:Z

    iput-boolean v3, v0, Landroid/support/v4/a/b;->e:Z
...
.method public final a(Landroid/arch/lifecycle/k;)V
    ...
    iput-object v0, p0, Landroid/support/v4/app/LoaderManagerImpl$a;->i:Landroid/arch/lifecycle/e;
...
.method public final a(Ljava/lang/Object;)V
    ...
    iget-object v0, p0, Landroid/support/v4/app/LoaderManagerImpl$a;->j:Landroid/support/v4/a/b;
    ...
    iput-object v0, p0, Landroid/support/v4/app/LoaderManagerImpl$a;->j:Landroid/support/v4/a/b;
...
.method final d()V
    ...
    iget-object v1, p0, Landroid/support/v4/app/LoaderManagerImpl$a;->i:Landroid/arch/lifecycle/e;
    ...
    invoke-interface {v1}, Landroid/arch/lifecycle/e;->a()Landroid/arch/lifecycle/c;
    ...
    sget-object v3, Landroid/arch/lifecycle/c$b;->a:Landroid/arch/lifecycle/c$b;
    ...
    iget-object v3, p0, Landroid/arch/lifecycle/LiveData;->b:Landroid/arch/a/b/b;

    invoke-virtual {v3, v0, v2}, Landroid/arch/a/b/b;->a(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {v0, v1}, Landroid/arch/lifecycle/LiveData$a;->a(Landroid/arch/lifecycle/e;)Z
...
.method final e()Landroid/support/v4/a/b;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    iput-boolean v1, v0, Landroid/support/v4/a/b;->d:Z
    ...
    iget-object v0, v0, Landroid/support/v4/app/LoaderManagerImpl$b;->a:Landroid/support/v4/a/b;
    ...
    iget-object v1, v0, Landroid/support/v4/a/b;->b:Landroid/support/v4/a/b$a;
    ...
    iput-object v1, v0, Landroid/support/v4/a/b;->b:Landroid/support/v4/a/b$a;
...
.method public final toString()Ljava/lang/String;
    ...
    iget v1, p0, Landroid/support/v4/app/LoaderManagerImpl$a;->e:I
    ...
    iget-object v1, p0, Landroid/support/v4/app/LoaderManagerImpl$a;->g:Landroid/support/v4/a/b;
