...
.method public static a(Landroid/content/Context;Landroid/support/v4/e/a;Landroid/support/v4/a/a/f$a;ZII)Landroid/graphics/Typeface;
    .locals 6
    ...
    invoke-virtual {p2, v0}, Landroid/support/v4/a/a/f$a;->a(Landroid/graphics/Typeface;)V
    ...
    invoke-virtual {p2, v1, v2}, Landroid/support/v4/a/a/f$a;->a(Landroid/graphics/Typeface;Landroid/os/Handler;)V
    ...
    invoke-virtual {p2, v1, v2}, Landroid/support/v4/a/a/f$a;->a(ILandroid/os/Handler;)V
    ...
    :try_start_0
    sget-object v0, Landroid/support/v4/e/b;->d:Landroid/support/v4/e/c;
    ...
    :goto_2
    sget-object v5, Landroid/support/v4/e/b;->b:Ljava/lang/Object;
    ...
    invoke-direct {v0, p2, v2}, Landroid/support/v4/e/b$2;-><init>(Landroid/support/v4/a/a/f$a;Landroid/os/Handler;)V
    ...
    invoke-virtual {v0, v5}, Landroid/support/v4/e/c;->a(Ljava/lang/Runnable;)V
...
.method static a(Landroid/content/Context;Landroid/support/v4/e/a;I)Landroid/support/v4/e/b$c;
    ...
    iget-object v6, p1, Landroid/support/v4/e/a;->a:Ljava/lang/String;
    ...
    iget-object v8, p1, Landroid/support/v4/e/a;->b:Ljava/lang/String;
    ...
    invoke-static {v7, v8}, Landroid/support/v4/e/b;->a(Ljava/util/List;Ljava/util/List;)Z
    ...
    :goto_4
    iget v1, v0, Landroid/support/v4/e/b$a;->a:I

    if-nez v1, :cond_7

    iget-object v0, v0, Landroid/support/v4/e/b$a;->b:[Landroid/support/v4/e/b$b;

    invoke-static {p0, v0, p2}, Landroid/support/v4/graphics/c;->a(Landroid/content/Context;[Landroid/support/v4/e/b$b;I)Landroid/graphics/Typeface;
    ...
    invoke-static {v1, v0}, Landroid/support/v4/a/a/c;->a(Landroid/content/res/Resources;I)Ljava/util/List;
    ...
    :cond_7
    iget v0, v0, Landroid/support/v4/e/b$a;->a:I
